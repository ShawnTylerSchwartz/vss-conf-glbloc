                    ...
                    echo "<div class='modal-content'>";
                        //echo "<span class='close'>&times;</span>";
                            ...
                            echo "<span class='confRatingButtonsRow'>";
                                // echo "$img";
                                echo "<input name='JOLItem$i' type='text' value='' id='confRating$i' placeholder='Confidence Rating' maxlength='2' autocomplete='off' class='forceNumeric textcenter collectorInput' style='margin: 0 auto; display: block;' onkeyup='CheckNo(this,$i)'>";
...
<div class="textcenter">
    <hr />
    <p>Of the 10 items that you placed, how many do you think you correctly placed?
    <br />
    <em>(Range 0 to 10)</em></p>
    <input name="UserRatedCorrectlyPlacedItems" type="text" value="" id="correctlyPlacedItems" placeholder="How Many?" maxlength="2" autocomplete="off" class="forceNumeric textcenter collectorInput corValidate" onblur="CheckCorVal(this)" onkeyup="checkUpdatedIptValue(this)" style="margin: 0 auto; display: block;">
</div>
...
<script>
    ...
    function swapImgs(td1, td2) {
        ...
        if (($(".imgOptions").find("img").length === 0) && (document.getElementById('correctlyPlacedItems').value >= 0) && (document.getElementById('correctlyPlacedItems').value <= 10) && (document.getElementById('correctlyPlacedItems').value != '')) {
    ...
    $("body").on("mouseup", function() {
        ...
        if(($("body").hasClass("imgOrigLoc")==false) && ($("body").hasClass("finished")==false)) {
